...
MAKE_PARAMS="ARCH=arm64 CC=clang CLANG_TRIPLE=aarch64-linux-gnu- LLVM=1 LLVM_IAS=1 \
...
mkdir -p out
make O=out $MAKE_PARAMS $DEFCONFIG
cd out
...
elif ! git clone -q https://github.com/ETCHDEV/AnyKernel3 -b lisa; then
